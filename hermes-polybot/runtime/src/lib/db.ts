...
export async function withDbRetry<T>(
  ...
  const RETRYABLE = /ETIMEDOUT|ECONNRESET|ECONNREFUSED|EPIPE|Connection terminated|socket hang up|CONNECTION_CLOSED|CONNECT_TIMEOUT|ENOTFOUND|EHOSTUNREACH/i;
