  ...
  return (
    <main className="panel overflow-x-auto p-4">
      ...
      <table className="table-base">
        <thead><tr><th>#</th><th>Wallet</th><th>Status</th><th>Global</th><th>ROI 30d</th><th>Consistency</th><th>Copyability</th><th>1-hit penalty</th><th>Short-term</th><th>Best category</th><th>Reason</th></tr></thead>
        <tbody>
          {rows.map((w: any) => (
            <tr key={w.address}>
              <td>{w.sourceRank}</td>
              ...
              <td>{w.shortTermShare != null ? `${(w.shortTermShare * 100).toFixed(0)}%` : '—'}</td>
